...
public class UpgradeTicketOffice extends Command {
    ...
    public UpgradeTicketOffice(DocumentaryCenterId documentaryCenterId,TicketOfficeId ticketOfficeId, NumberOfBallots numberOfBallots, Date dateDay, Money ticketMoney, InvoiceDescription ticketDescription) {
