...
public class AddPucharSelnvoice implements Command {
    ...
    public AddPucharSelnvoice(DocumentaryCenterId documentaryCenterId, Date datePurchase, Money purchaseMoney, InvoiceDescription purchaseDescription, CompanyName companyName) {
